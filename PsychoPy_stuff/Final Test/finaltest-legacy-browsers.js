...
function COUNTERBALANCERoutineBegin(snapshot) {
  return async function () {
    ...
    COUNTERBALANCEComponents.forEach( function(thisComponent) {
...
function LoopParametersLoopBegin(LoopParametersLoopScheduler, snapshot) {
  return async function() {
    ...
    LoopParameters.forEach(function() {
...
function pracitce_wrdsLoopBegin(pracitce_wrdsLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    pracitce_wrds.forEach(function() {
...
function practice_imagessLoopBegin(practice_imagessLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    practice_imagess.forEach(function() {
...
function practice_testtLoopBegin(practice_testtLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    practice_testt.forEach(function() {
...
function LearningSetOneLoopBegin(LearningSetOneLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    LearningSetOne.forEach(function() {
...
function LearningSetTwoLoopBegin(LearningSetTwoLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    LearningSetTwo.forEach(function() {
...
function LearningSetThreeLoopBegin(LearningSetThreeLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    LearningSetThree.forEach(function() {
...
function LearningSetFourLoopBegin(LearningSetFourLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    LearningSetFour.forEach(function() {
...
function checkmark_loop4LoopBegin(checkmark_loop4LoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    checkmark_loop4.forEach(function() {
...
function LoadCharactersRoutineBegin(snapshot) {
  return async function () {
    ...
    LoadCharactersComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function RemoveNoneRoutineBegin(snapshot) {
  return async function () {
    ...
    RemoveNoneComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function GenerateQuestionsRoutineBegin(snapshot) {
  return async function () {
    ...
    GenerateQuestionsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function practice_welcomeRoutineBegin(snapshot) {
  return async function () {
    ...
    practice_welcomeComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function practice_wrdssRoutineBegin(snapshot) {
  return async function () {
    ...
    practice_wrdssComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function plusBetweenRoutineBegin(snapshot) {
  return async function () {
    ...
    plusBetweenComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function breakBetweenSetsRoutineBegin(snapshot) {
  return async function () {
    ...
    breakBetweenSetsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function practice_imagesRoutineBegin(snapshot) {
  return async function () {
    ...
    practice_imagesComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function checkForCorr_5RoutineBegin(snapshot) {
  return async function () {
    ...
    checkForCorr_5Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function checkmarkRoutineBegin(snapshot) {
  return async function () {
    ...
    checkmarkComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function xmarkRoutineBegin(snapshot) {
  return async function () {
    ...
    xmarkComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function resetRepsRoutineBegin(snapshot) {
  return async function () {
    ...
    resetRepsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function randomize_setRoutineBegin(snapshot) {
  return async function () {
    ...
    randomize_setComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function IncrementRoutineBegin(snapshot) {
  return async function () {
    ...
    IncrementComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function amharic1_ARoutineBegin(snapshot) {
  return async function () {
    ...
    amharic1_AComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function amharic1_BRoutineBegin(snapshot) {
  return async function () {
    ...
    amharic1_BComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function breakBetweenRepeatsRoutineBegin(snapshot) {
  return async function () {
    ...
    breakBetweenRepeatsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function routine_30SecondsRoutineBegin(snapshot) {
  return async function () {
    ...
    routine_30SecondsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function start_testRoutineBegin(snapshot) {
  return async function () {
    ...
    start_testComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function test1_NEWRoutineBegin(snapshot) {
  return async function () {
    ...
    test1_NEWComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function checkForCorrRoutineBegin(snapshot) {
  return async function () {
    ...
    checkForCorrComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function amharic2_ARoutineBegin(snapshot) {
  return async function () {
    ...
    amharic2_AComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function amharic2_BRoutineBegin(snapshot) {
  return async function () {
    ...
    amharic2_BComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function test2_NEWRoutineBegin(snapshot) {
  return async function () {
    ...
    test2_NEWComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function checkForCorr_2RoutineBegin(snapshot) {
  return async function () {
    ...
    checkForCorr_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function amharic3_ARoutineBegin(snapshot) {
  return async function () {
    ...
    amharic3_AComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function amharic3_BRoutineBegin(snapshot) {
  return async function () {
    ...
    amharic3_BComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function test3_NEWRoutineBegin(snapshot) {
  return async function () {
    ...
    test3_NEWComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function checkForCorr_3RoutineBegin(snapshot) {
  return async function () {
    ...
    checkForCorr_3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function amharic4_ARoutineBegin(snapshot) {
  return async function () {
    ...
    amharic4_AComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function amharic4_BRoutineBegin(snapshot) {
  return async function () {
    ...
    amharic4_BComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function test4_NEWRoutineBegin(snapshot) {
  return async function () {
    ...
    test4_NEWComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function checkForCorr_4RoutineBegin(snapshot) {
  return async function () {
    ...
    checkForCorr_4Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function WelcomeSlideRoutineBegin(snapshot) {
  return async function () {
    ...
    WelcomeSlideComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function TestQuestionRoutineBegin(snapshot) {
  return async function () {
    ...
    TestQuestionComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function EvaluateRoutineBegin(snapshot) {
  return async function () {
    ...
    EvaluateComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
