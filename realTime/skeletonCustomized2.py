...
def draw(symbol, pred=None):
    ...
    draw_gradient(COLORS['bg_top'], COLORS['bg_bot'])

    title_surf = font.render(symbol, True, (255,255,255))
    ...
    if pred is not None:
        ...
        resp_surf = small.render(label, True, color)
        resp_rect = resp_surf.get_rect(center=(WIDTH//2, HEIGHT*2//3))
