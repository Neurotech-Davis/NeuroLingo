...
# This version of preprocessing just changes the preproceessing function such that it takes in raw data instead of file paths
# allows the optimization code to skip reading the files everytime
...
def preprocessing(raw, log_df, psychopy_df, participantName, consider_certainty, certainty_threshold, n_components, t_min, t_max):
