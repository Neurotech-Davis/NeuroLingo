...
# # how to access indidivudal combos and their parts:
# print("first parameter", ParameterGrid(preprocess_grid)[0])
# print("second parameter", ParameterGrid(preprocess_grid)[1]['model'])

# 'model' : ['rbf_svm', 'linear_svm', 'poly_svm', 'RandomForest', 'LDA', 'kNN', 'NeuralNet']
...
def preprocess(setting):
    """
    input: a preprocessing arg
    output: X, y
    """
    # make a prettier way to index through participant data
...
def optimization():
    ...
    # print("main_list first option:", main_list[0])
    # note: when reading accuracies it will go model, accuracy, cm
